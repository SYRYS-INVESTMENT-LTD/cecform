...
function FormSectionA() {
    ...
    const onsubmit = async (event) => {
        ...
        const data = {
            ...
            applyas: applyingas,
            educationobjective: educationalobjective,
            course: course,
            ...
            country: country,
            street: streetorboxnumber,
            city: townorcity,
            homephone: phonenumber,
            zip: postalorzipcode,

            onefirstname: guardianfirstname,
            onesurnname: guardianlastname,
            onemiddlename: guardianmiddlename,
            onestreet: guardianstreetorboxnumber,
            onephone: guardianphonenumber,
            oneemail: guardianemailaddress,
            onecity: guardiantownorcity,
            onezip: guardianpostalorzipcode,
            onecountry: guardiancountry,

            twofirstname: guardianBfirstname,
            twosurnname: guardianBlastname,
            twomiddlename: guardianBmiddlename,
            twostreet: guardianBstreetorboxnumber,
            twophone: guardianBphonenumber,
            twoemail: guardianBemailaddress,
            twocity: guardianBtownorcity,
            twozip: guardianBpostalorzipcode,
            twocountry: guardianBcountry,
